...
UPDATE novkovic_3_osobe_2 SET ime = 'Lana', prezime = 'Lanic' WHERE jmbg = 234;
UPDATE novkovic_3_osobe_2 SET broj_cipela = broj_cipela + 1;
DELETE FROM novkovic_3_osobe_2 WHERE jmbg = 345;
 
SELECT * FROM novkovic_3_osobe_2;
